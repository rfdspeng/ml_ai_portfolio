...
class BookAssistant:
    def __init__(self, llm_api_key: str, system_message: str="You are a bookstore assistant assisting customers with finding a book to read that fits their preferences.", model: str="gpt-3.5-turbo"):
        self.llm_client = OpenAI(api_key=llm_api_key) # AsyncOpenAI
    ...
    # async
    def respond(self, user_query: str="", search_results: list=[], stream: bool=False):
        ...
        # Response
        response = self.llm_client.chat.completions.create( # await
